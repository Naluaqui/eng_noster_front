...
export const decisionImpactFlows: Record<string, DecisionImpactFlowData> = {
  'kickoff-noster': {
    ...
    actions: ['Desenhar o fluxo de análise', 'Definir personas ativas', 'Validar formato com reuniões reais'],
  },
  'priorizacao-roadmap': {
    ...
    centralDecision: {
      ...
      description: 'A decisão deixa de ser só volume de pedidos e passa a considerar risco e retorno.',
    },
    decisions: [
      {
  ...
  'go-no-go': {
    ...
    actions: ['Registrar critérios', 'Validar custo operacional', 'Definir próximo marco de decisão'],
  },
  'analise-objeções': {
    ...
    actions: ['Reescrever pitch de ROI', 'Criar perguntas de fechamento', 'Marcar objeções recorrentes'],
  },
};
