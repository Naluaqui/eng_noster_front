...
export const persuasionSocials = ['Instagram', 'Facebook', 'X', 'LinkedIn', 'Telegram'] as const;

export const persuasionTracks = [
  {
    id: 'valor-roi',
...
export const persuasionSidebarStats = [
...
export const persuasionWorklist = [
  {
  ...
  },
  {
    ...
    priority: 'Alta',
    channel: 'document',
    avatar: 'https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?auto=format&fit=crop&w=240&q=80',
  },
  {
    id: 'jack-donovan',
    name: 'Jack Donovan',
